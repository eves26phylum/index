        ...
        <div className="default blog">
            ...
            <div className="skill-list">
                ...
                <Tooltip label="ROBLOX Studio" open={true}>
                    <NavLink to="https://create.roblox.com">
                ...
                <Tooltip label="macOS" open={true}>
                    <NavLink to="https://www.apple.com/macos/">
            ...
            <div className="skill-list">
                ...
                <Tooltip label="HTML" open={true}>
                    <NavLink to="https://developer.mozilla.org/docs/Web/HTML">
            ...
            <div className="skill-list">
                <Tooltip label="I'm Learning" open={true}>
                    <NavLink to="https://files.blogs.baruch.cuny.edu/wp-content/blogs.dir/2418/files/2013/04/Mihaly-Csikszentmihalyi-Flow.pdf">
